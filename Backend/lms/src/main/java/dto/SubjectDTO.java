...
public class SubjectDTO {
	...
	public SubjectDTO(Long id, String name, int ects, boolean compulsory, int numberOfClasses, int numberOfPractices,
			...
			YearOfStudyDTO yearOfStudy, OutcomeDTO aftermath, SubjectDTO prerequisite) {
		this.id = id;
		this.name = name;
		this.ects = ects;
	...
	public OutcomeDTO getAftermath() {
		return aftermath;
	}

	public void setAftermath(OutcomeDTO aftermath) {
		this.aftermath = aftermath;
	}
